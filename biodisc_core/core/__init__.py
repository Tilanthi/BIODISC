...
class UnifiedBIODISCSystem:
    ...
    Usage:
        >>> system = UnifiedBIODISCSystem(mode="general")
...
def create_biodisc_system(mode: str = "general", config: Optional[Dict[str, Any]] = None) -> UnifiedBIODISCSystem:
    """
    ...
    Returns:
        Initialized UnifiedBIODISCSystem
    """
    return UnifiedBIODISCSystem(mode=mode, config=config)
