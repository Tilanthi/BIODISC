...
try:
    from .unified import UnifiedBIODISCSystem, UnifiedConfig, TaskType, TaskAnalyzer
...
class EnhancedUnifiedBIODISCSystem:
    ...
    def __init__(self, config: Optional[EnhancedUnifiedConfig] = None):
        ...
        if UnifiedBIODISCSystem is not None:
            ...
            self.base_system = UnifiedBIODISCSystem(config=base_config)
...
def create_biodisc_system(config: Optional[EnhancedUnifiedConfig] = None) -> EnhancedUnifiedBIODISCSystem:
    ...
    Returns:
        EnhancedUnifiedBIODISCSystem instance
    """
    return EnhancedUnifiedBIODISCSystem(config)


# Backwards compatibility aliases
create_enhanced_stan_system = create_biodisc_system  # Deprecated
create_stan_system = create_biodisc_system  # Deprecated
