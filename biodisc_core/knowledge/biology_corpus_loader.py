...
class BiologyCorpusLoader:
    ...
    def __init__(self, corpus_dir: str = None):
        ...
        if corpus_dir is None:
            corpus_dir = '/Users/gjw255/astrodata/SWARM/BIODISC/biodisc_core/corpus'
...
if __name__ == '__main__':
    ...
    # Save snapshot
    output_path = Path('/Users/gjw255/astrodata/SWARM/BIODISC/biodisc_core/knowledge/corpus_snapshot.json')
