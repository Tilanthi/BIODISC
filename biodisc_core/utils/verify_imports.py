...
def test_pdf_generator_imports():
    ...
    try:
        from biodisc_core.utils.pdf_generator import (
...
def test_legacy_system_imports():
    ...
    try:
        from biodisc_core.legacy.systems.v36 import V36CoreSystem
        print("  ✓ V36CoreSystem")
        return True
    except Exception as e:
        print(f"  ✗ Failed: {e}")
...
def test_core_unified_imports():
    ...
    try:
        from biodisc_core.core.unified import (
            TaskType,
            UnifiedConfig,
