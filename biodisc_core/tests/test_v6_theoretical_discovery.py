...
from biodisc_core.theoretical_discovery import (
...
def test_integration_with_astra_core():
    """Test integration with main astra_core system"""
    print("\n[Integration with STAN Core]")

    try:
        from biodisc_core import V6TheoreticalDiscovery, create_v6_theoretical_system
        print("  ✓ V6.0 components exported from biodisc_core")
...
def run_all_tests():
    ...
    tests = [
        ...
        ("STAN Core Integration", test_integration_with_astra_core),
    ]
