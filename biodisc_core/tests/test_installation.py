...
def test_imports():
    ...
    from biodisc_core.memory import EpisodicMemory, SemanticMemory
    assert EpisodicMemory is not None
    assert SemanticMemory is not None
    print("✓ Memory components")

    from biodisc_core.discovery import HypothesisGenerator
    assert HypothesisGenerator is not None
    print("✓ Discovery components")

    from biodisc_core.simulation import PhysicsSimulator
    assert PhysicsSimulator is not None
    print("✓ Simulation components")

    from biodisc_core.metacognitive import CognitiveMonitor
    assert CognitiveMonitor is not None
    print("✓ Meta-cognitive components")

    from biodisc_core.neural import MultiLayerPerceptron, Trainer
...
def test_basic_functionality():
    ...
    # Test SCM creation
    from biodisc_core.causal.model.scm import (
    ...
    from biodisc_core.memory.episodic.memory import Experience, EpisodicMemory
    ...
    from biodisc_core.metacognitive.monitoring.monitor import CognitiveMonitor
