...
class V5TestSuite:
    ...
    def test_v101_temporal_causal(self):
        ...
        try:
            ...
            from biodisc_core.capabilities.v101_temporal_causal import create_granger_fci_hybrid
    ...
    def test_v5_orchestrator(self):
        ...
        try:
            from biodisc_core.v5_discovery_orchestrator import (
