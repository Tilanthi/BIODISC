...
def test_v47_causal_imports():
    ...
    from biodisc_core.causal.discovery import (
    ...
    from biodisc_core.causal.inference import (
    ...
    from biodisc_core.causal import (
        BayesianStructureLearner,
        ExpectedInformationGainCalculator,
        OnlineCausalLearner,
        SimulationBasedInferenceEngine,
...
def test_v47_physics_imports():
    ...
    from biodisc_core.physics import (
        RelativisticPhysics,
        QuantumMechanics,
        NuclearAstrophysics,
    )
...
def test_v47_metalearning_imports():
    ...
    try:
        from biodisc_core.reasoning.maml_optimizer import (
            MAMLOptimizer,
...
def test_physics_cross_module_calls():
    ...
    from biodisc_core.physics import UnifiedPhysicsEngine, RelativisticPhysics
    from biodisc_core.domains import BaseDomainModule, DomainConfig
...
def test_causal_physics_integration():
    ...
    from biodisc_core.causal import StructuralCausalModel
    from biodisc_core.physics import PhysicsConstraint
...
def test_domain_causal_integration():
    ...
    from biodisc_core.domains import HighEnergyDomain
...
def test_unified_orchestrator():
    ...
    try:
        from biodisc_core.core.unified import create_unified_stan_system
        print("  ✓ create_unified_stan_system imported")
    except ImportError as e:
        print(f"  ⚠ Unified system not available (expected in degraded mode): {e}")

    try:
        from biodisc_core.core.unified_enhanced import create_enhanced_stan_system
...
def test_causal_graceful_degradation():
    ...
    from biodisc_core.causal.discovery.bayesian_structure_learning import (
        BayesianStructureLearner,
        InferenceMethod,
    )
...
def test_active_discovery_pipeline():
    ...
    from biodisc_core.causal.discovery.eig_calculator import (
        create_eig_calculator, ObservationPlan, NoiseModel
    )
    from biodisc_core.causal.discovery.online_causal_learning import (
