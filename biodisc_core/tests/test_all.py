...
class TestCausalDiscovery:
    ...
    def test_pc_algorithm_simple_chain(self):
        ...
        from biodisc_core.causal.discovery.pc_algorithm import PCAlgorithm
    ...
    def test_temporal_discovery(self):
        ...
        from biodisc_core.causal.discovery.temporal_discovery import (
...
class TestMemorySystems:
    ...
    def test_episodic_memory(self):
        ...
        from biodisc_core.memory.episodic.memory import EpisodicMemory, Experience
    ...
    def test_working_memory(self):
        """Test working memory."""
        from biodisc_core.memory.working.memory import WorkingMemory
    ...
    def test_semantic_memory(self):
        ...
        from biodisc_core.memory.semantic.memory import (
            SemanticMemory,
            Concept,
            RelationType
        )
...
class TestSimulation:
    ...
    def test_physics_simulator(self):
        ...
        from biodisc_core.simulation.physics.simulator import PhysicsSimulator
    ...
    def test_astronomy_simulator(self):
        ...
        from biodisc_core.simulation.physics.simulator import AstronomySimulator
...
class TestNeuralTraining:
    ...
    def test_mlp(self):
        ...
        from biodisc_core.neural.training import MultiLayerPerceptron
    ...
    def test_trainer(self):
        ...
        from biodisc_core.neural.training import (
...
class TestMarketSimulation:
    ...
    def test_order_book(self):
        """Test order book."""
        from biodisc_core.simulation.market.simulator import (
            OrderBook,
            Order,
            OrderType
        )
    ...
    def test_market_simulation(self):
        ...
        from biodisc_core.simulation.market.simulator import MarketSimulation
...
class TestMetaCognition:
    ...
    def test_cognitive_monitor(self):
        ...
        from biodisc_core.metacognitive.monitoring.monitor import (
            CognitiveMonitor,
            ProcessState
        )
...
class TestIntegration:
    ...
    def test_unified_system(self):
        ...
        from biodisc_core.core import create_stan_system

        system = create_biodisc_system(mode="general")
