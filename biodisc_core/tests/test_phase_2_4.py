...
def test_domain_system():
    ...
    try:
        ...
        from biodisc_core.domains.exoplanets import ExoplanetDomain
...
def test_physics_curriculum():
    ...
    try:
        from biodisc_core.physics import PhysicsCurriculum, ComplexityLevel
...
def test_validation_benchmarks():
    ...
    try:
        from biodisc_core.tests.validation_benchmarks import (
            ValidationSuite,
            BenchmarkResult,
...
def test_enhanced_system():
    ...
    try:
        from biodisc_core.core.unified_enhanced import (
