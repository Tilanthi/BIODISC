...
# Project root is: ../ (from biodisc_core)
...
class TestV4Integration:
    ...
    def test_v4_coordinator_creation(self):
        ...
        from biodisc_core.v4_revolutionary import create_v4_coordinator
    ...
    def test_v4_process_query(self):
        ...
        from biodisc_core.v4_revolutionary import create_v4_coordinator, IntegrationMode
...
class TestASCIntegration:
    ...
    def test_asc_creation(self):
        ...
        from biodisc_core.self_teaching.autocatalytic_compiler import create_autocatalytic_self_compiler
...
class TestMMOLIntegration:
    ...
    def test_specialized_minds(self):
        ...
        from biodisc_core.intelligence.specialized_minds import (
