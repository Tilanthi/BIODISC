...
def test_enhanced_features():
    ...
    from biodisc_core.self_teaching.embedding_novelty import (
    ...
    from biodisc_core.self_teaching.scientific_data import (
        PhysicsDataLibrary,
    ...
    from biodisc_core.self_teaching.multi_agent_swarm import (
    ...
    # Agent breakdown
    from biodisc_core.self_teaching.multi_agent_swarm import AgentRole
    agent_counts = {}
    ...
    from biodisc_core.self_teaching.arxiv_integration import (
