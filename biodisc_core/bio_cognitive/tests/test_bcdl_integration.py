...
def test_module_imports():
    ...
    try:
        from biodisc_core.bio_cognitive import (
...
def test_abductive_theory_former():
    ...
    try:
        from biodisc_core.bio_cognitive import AbductiveTheoryFormer
...
def test_temporal_causal_discovery():
    ...
    try:
        from biodisc_core.bio_cognitive import TemporalCausalDiscovery
...
def test_multi_scale_reasoner():
    ...
    try:
        from biodisc_core.bio_cognitive import MultiScaleReasoner
...
def test_experimental_designer():
    ...
    try:
        from biodisc_core.bio_cognitive import ExperimentalDesigner
...
def test_discovery_value_calculator():
    ...
    try:
        from biodisc_core.bio_cognitive import DiscoveryValueCalculator
...
def test_full_bcdl_discovery():
    ...
    try:
        from biodisc_core.bio_cognitive import BioCognitiveDiscoveryLayer
