...
class ComprehensiveSystemTest:
    ...
    def _test_memory_graph(self) -> bool:
        from biodisc_core.memory import MemoryGraph
    ...
    def _test_causal_discovery(self) -> bool:
        try:
            from biodisc_core.reasoning.causal_discovery import PCAlgorithm
    ...
    def _test_v4_metacognitive(self) -> bool:
        try:
            from biodisc_core.metacognitive.meta_context_engine import MetaContextEngine
    ...
    def test_orchestrator(self):
        ...
        try:
            ...
            print("  create_biodisc_system()...", end=" ")
