...
class PrimitiveDiscoverer:
    """
    Discovers new computational primitives from existing algorithms.
    """

    def __init__(self):
        self.discovered_primitives: List[ComputationalPrimitive] = []
...
class AlgorithmicDiscoveryEngine:
    """
    Unified algorithmic discovery system.

    Integrates primitive library, algorithm generation,
    genetic evolution, evaluation, and primitive discovery.
    ...
    def discover_primitives(self, algorithms: List[DiscoveredAlgorithm] = None) -> List[ComputationalPrimitive]:
        """Discover new primitives."""
        algos = algorithms or self.discovered_algorithms
        return self.primitive_discoverer.discover_primitives(algos)


# Factory functions
def create_algorithmic_discovery_engine() -> AlgorithmicDiscoveryEngine:
    """Create an algorithmic discovery engine."""
    return AlgorithmicDiscoveryEngine()


def discover_algorithm_for_data(data: Any, problem_type: str = "general") -> DiscoveredAlgorithm:
    """
    Discover an algorithm for specific data.

    Simplified interface for discovering algorithms from data patterns.
    """
