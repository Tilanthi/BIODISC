...
\date{Version 1.00. Accepted XXX. Received YYY; in original form ZZZ.}
...
pure client change), booking TTLs second, priority last.  Kill
...
\texttt{gen\_tables.py}, \texttt{make\_figures.py}); all tables and
figures in this paper are generated from
\texttt{traffic\_results.json} with no hand-transcribed numbers.
Version 1.00; results and text version together in future updates.
